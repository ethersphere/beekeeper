...
func (c *command) initStartNode() *cobra.Command {
	const (
		clusterName               = "main"
		nodeGroupName             = "bootnode"
		nodeGroupVersion          = "latest"
		nodeName                  = "bee"
		nodeName2                 = "drone"
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			nodeConfig2.Standalone = standalone
			cluster := bee.NewDynamicCluster(bee.DynamicClusterOptions{
				Name:      clusterName,
				Namespace: namespace,
			...
			err = cluster.NodeStart(ctx, nodeGroupName, bee.NodeStartOptions{
				...
				DebugAPIURL:      "http://bee-0-debug.beekeeper.staging.internal",
			...
			err = cluster.NodeStart(ctx, nodeGroupName, bee.NodeStartOptions{
				Name:             nodeName2,
				Config:           nodeConfig2,
				APIURL:           "http://bee-1.beekeeper.staging.internal",
				...
				ClefPassword:     "clefbeesecret",
				DebugAPIURL:      "http://bee-1-debug.beekeeper.staging.internal",
				IngressHost:      "bee-1.beekeeper.staging.internal",
				IngressDebugHost: "bee-1-debug.beekeeper.staging.internal",
			...
			fmt.Println(cluster.NodeGroup(nodeGroupName).Nodes())
			return
		},
...
var (
	...
	nodeConfig2 = k8s.Config{
		APIAddr:              ":8080",
		Bootnodes:            "/dns4/bee-1-headless.beekeeper.svc.cluster.local/tcp/7070/p2p/16Uiu2HAmMw7Uj6vfraD9BYx3coDs6MK6pAmActE8fsfaZwigsaB6",
		ClefSignerEnable:     false,
		ClefSignerEndpoint:   "",
		CORSAllowedOrigins:   "",
		DataDir:              "/home/bee/.bee",
