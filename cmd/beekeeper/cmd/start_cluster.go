...
func (c *command) initStartCluster() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			ngOptions.PersistenceEnabled = true
			...
			ng2Options.PersistenceEnabled = true
			cluster.AddNodeGroup(nodeGroup2Name, ng2Options)
			ng2 := cluster.NodeGroup(nodeGroup2Name)

			bn1Config := beeDefaultConfig
			bn1Config.Bootnodes = "/dns4/bootnode-1-headless.beekeeper.svc.cluster.local/tcp/7070/p2p/16Uiu2HAmMw7Uj6vfraD9BYx3coDs6MK6pAmActE8fsfaZwigsaB6"
			...
			bn2Config.Bootnodes = "/dns4/bootnode-0-headless.beekeeper.svc.cluster.local/tcp/7070/p2p/16Uiu2HAm6i4dFaJt584m2jubyvnieEECgqM2YMpQ9nusXfy8XFzL"
			if err := ng.NodeStart(ctx, bee.NodeStartOptions{
				Name:         "bootnode-1",
				Config:       bn2Config,
			...
			b1Config.Bootnodes = "/dns4/bootnode-0-headless.beekeeper.svc.cluster.local/tcp/7070/p2p/16Uiu2HAm6i4dFaJt584m2jubyvnieEECgqM2YMpQ9nusXfy8XFzL /dns4/bootnode-1-headless.beekeeper.svc.cluster.local/tcp/7070/p2p/16Uiu2HAmMw7Uj6vfraD9BYx3coDs6MK6pAmActE8fsfaZwigsaB6"
			...
			b2Config.Bootnodes = "/dns4/bootnode-0-headless.beekeeper.svc.cluster.local/tcp/7070/p2p/16Uiu2HAm6i4dFaJt584m2jubyvnieEECgqM2YMpQ9nusXfy8XFzL /dns4/bootnode-1-headless.beekeeper.svc.cluster.local/tcp/7070/p2p/16Uiu2HAmMw7Uj6vfraD9BYx3coDs6MK6pAmActE8fsfaZwigsaB6"
			if err := ng2.NodeStart(ctx, bee.NodeStartOptions{
				Name:   "bee-1",
				Config: b2Config,
			}); err != nil {
			...
			b3Config.Bootnodes = "/dns4/bootnode-0-headless.beekeeper.svc.cluster.local/tcp/7070/p2p/16Uiu2HAm6i4dFaJt584m2jubyvnieEECgqM2YMpQ9nusXfy8XFzL /dns4/bootnode-1-headless.beekeeper.svc.cluster.local/tcp/7070/p2p/16Uiu2HAmMw7Uj6vfraD9BYx3coDs6MK6pAmActE8fsfaZwigsaB6"
			if err := ng2.NodeStart(ctx, bee.NodeStartOptions{
				Name:   "bee-2",
				Config: b3Config,
			}); err != nil {
