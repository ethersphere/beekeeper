...
func setupBootnodes(n int, ns string) []bootnodeSetup {
	...
	case 2:
		return []bootnodeSetup{
			{
				Bootnodes:    fmt.Sprintf("/dns4/bootnode-1-headless.%s.svc.cluster.local/tcp/7070/p2p/16Uiu2HAmMw7Uj6vfraD9BYx3coDs6MK6pAmActE8fsfaZwigsaB6", ns),
			...
			{
				Bootnodes:    fmt.Sprintf("/dns4/bootnode-0-headless.%s.svc.cluster.local/tcp/7070/p2p/16Uiu2HAm6i4dFaJt584m2jubyvnieEECgqM2YMpQ9nusXfy8XFzL", ns),
...
func setupBootnodesDNS(n int, ns string) string {
	switch n {
	case 2:
		return fmt.Sprintf("/dns4/bootnode-0-headless.%s.svc.cluster.local/tcp/7070/p2p/16Uiu2HAm6i4dFaJt584m2jubyvnieEECgqM2YMpQ9nusXfy8XFzL /dns4/bootnode-1-headless.%s.svc.cluster.local/tcp/7070/p2p/16Uiu2HAmMw7Uj6vfraD9BYx3coDs6MK6pAmActE8fsfaZwigsaB6", ns, ns)
	default:
		return fmt.Sprintf("/dns4/bootnode-0-headless.%s.svc.cluster.local/tcp/7070/p2p/16Uiu2HAm6i4dFaJt584m2jubyvnieEECgqM2YMpQ9nusXfy8XFzL", ns)
	}
}
