...
var (
	...
	setup0 = bootnodeSetup{
		Bootnode:     "/dns4/%s-headless.%s.svc.cluster.local/tcp/7070/p2p/16Uiu2HAm6i4dFaJt584m2jubyvnieEECgqM2YMpQ9nusXfy8XFzL",
	...
	setup1 = bootnodeSetup{
		Bootnode:     "/dns4/%s-headless.%s.svc.cluster.local/tcp/7070/p2p/16Uiu2HAmMw7Uj6vfraD9BYx3coDs6MK6pAmActE8fsfaZwigsaB6",
